...
[_QW] = { /* Qwerty */
  ...
  {KC_ESC, KC_TAB, KC_LGUI,  OSM(MOD_LSFT), KC_BSPC,  KC_LALT, KC_SPC,  OSL(_RS), KC_MINS, KC_QUOT, KC_ENT  }
},
/*
 *  !       @     up     {    }        ||     pgup    7     8     9    *
 ...
 */
[_RS] = { /* [> RAISE <] */
  {KC_EXLM, KC_AT,   KC_UP,   KC_LCBR, KC_RCBR, KC_TRNS, KC_0, KC_7,    KC_8,   KC_9, KC_ASTR},
  {KC_HASH, KC_LEFT, KC_DOWN, KC_RGHT, KC_DLR,  KC_TRNS, KC_EQL, KC_4,    KC_5,   KC_6, KC_PLUS},
  {KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_AMPR, KC_LCTL, KC_GRV,  KC_1,    KC_2,   KC_3, KC_BSLS},
  {TG(_LW), KC_INS,  KC_LGUI, KC_LSFT, KC_DELT, KC_LALT, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_ENT}
},
/*
